...
def get_arguments():
    ...
    parser.add_argument("--tidigits-path", type=str, default=DEFAULT_DATASET_PATH,
                        help="Path to TIDIGITS training dataset")
...
def feature_extraction(dataset_path, save_path, phoneHMMs, state_list, add_short_pause = False):
    """
    """
...
feature_extraction(tidigits_path, saving_path, phoneHMMs, state_list)
